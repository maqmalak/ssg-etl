...
#     query = """
#         SELECT TOP 10
#             g.Dated, g.Vtp, g.ScrVoucher_NO, g.EntryNo,
#             g.debit, g.credit, g.Narration, g.FinancialYear,
#             g.CreationDate, g.VoucherDate, g.Prp_Date, g.Prp_ID,
#             g.ChqDate, g.ChqClearanceDate, g.Chk_Date, g.ChqNo,
#             g.ChallanNo, g.CancellDate, g.CancelledBy,
#             c.TypeOfID, c.LevelNo, u3.ID AS Level_id1, u3.Title AS Upper_Level_1_Title,
#             u4.ID AS Level_id2, u4.Title AS Upper_Level_2_Title,
#             coa3.ULID2 AS Sub_id, c.id AS Account_id, c.Title AS Account_Title,
#             CASE 
...
#     params = []
#     if last_extract_dt:
#         query += " AND g.CreationDate > ?"
#         params = [last_extract_dt]
        
#     query += " ORDER BY g.CreationDate ASC;"
...
#                     max(tx["CreationDate"] for tx in batch if tx.get("CreationDate"))
#                     if batch else None
#                 )
...
#             # In case of error, it's safer to proceed with extraction
#             logger.info(f"[{connection_id}] DECISION: SAVE PATH (Error occurred, proceeding for safety)")
#             return True
