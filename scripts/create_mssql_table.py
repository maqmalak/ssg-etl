#!/usr/bin/env python3
"""
Script to create the general_ledger_transactions table in MSSQL
"""
import os
import sys
...
from dags.dynamic_db_etl import GeneralLedgerTransaction, get_target_mssql_engine

def create_table():
    """Create the general_ledger_transactions table in MSSQL database."""
    try:
        # Get the MSSQL engine
