            ...
            while True:
                ...
                for row in rows:
                    ...
                    batch.append({
                        ...
                        'qcr_date': row_dict.get('qcr_date'),
...
def save_to_postgres(connection_id: str) -> str:
    ...
    try:
        ...
        perform_memory_cleanup("Final cleanup")
...
def qcr_upsert_to_postgres(connection_id: str) -> str:
    ...
    try:
        ...
        engine.dispose()
        perform_memory_cleanup("Upsert cleanup")
