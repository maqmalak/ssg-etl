...
def fetch_data_from_source(connection_id: str) -> Generator[List[Dict[str, Any]], None, None]:
    ...
    query = """
        SELECT
            ...
            CAST(IHS.dbo.ODP_Detail.ODPD_Workstation AS CHAR) AS odpd_workstation,
            ...
            CAST(IHS.dbo.ODP_Detail.ODPD_CM_Key AS CHAR) AS odpd_cm_key,

            Colour_Master_1.CM_Description AS cm_description,
            CAST(IHS.dbo.ODP_Detail.ODPD_SM_Key AS CHAR) AS odpd_sm_key,
        ...
        while True:
            ...
            for r in rows:
                ...
                batch.append({
                    ...
                    "odpd_oc_key": str(d.get("odpd_oc_key")) if d.get("odpd_oc_key") else None,
                    ...
                    "odpd_cm_key": str(d.get("odpd_cm_key")) if d.get("odpd_cm_key") else None,
                    "cm_description": str(d.get("cm_description")) if d.get("cm_description") else None,
                    "odpd_sm_key": str(d.get("odpd_sm_key")) if d.get("odpd_sm_key") else None,
