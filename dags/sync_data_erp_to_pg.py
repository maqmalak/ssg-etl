...
INCLUDED_VIEWS = ["ClientPurchaseOrder","LoadingInformation","OperationInformation","hangerline_emp","v_attenandance","ina_operation_list"]  # ✅ specify views to sync (case-sensitive)
